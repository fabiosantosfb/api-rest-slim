...
namespace controllers{
	...
	Classe pessoa
	*/
	class Pessoa extends \Dao\Conexao{
		...
		*/
		function __construct(){
			$this->PDO = new \PDO('mysql:host=localhost;dbname=api', 'root', 'fabioadmin'); //Conexão
	...
	//public function lista(){
	//		global $app;
	//		$sth = Parent::getInstanceConexao()->prepare("SELECT * FROM panificadora");
	//		$sth->execute();
	//		$result = $sth->fetchAll(\PDO::FETCH_ASSOC);
//
	//		$app->render('default.php',["data"=>$result],200);
